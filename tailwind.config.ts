  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "white-1": "hsl(0, 0%, 100%)",
        "white-2": "hsl(0, 0%, 98%)",
        "orange-yellow-crayola": "hsl(169, 62%, 57%)",
        "orange-yellow-crayola-dark": "hsl(45, 100%, 10%)",
        "vegas-gold": "	hsl(188, 47%, 48%)",
      ...
      backgroundImage: {
        ...
        "gradient-yellow-1":
          "linear-gradient(to bottom right, hsl(169, 62%, 57%) 0%, hsla(36, 100%, 69%, 0) 50%)",
        "gradient-yellow-2":
        ...
        "text-gradient-yellow":
          "linear-gradient(to right, hsl(169, 62%, 57%), hsl(188, 47%, 48%))",
      },
      borderRadius: {
        lg: `var(--radius)`,
